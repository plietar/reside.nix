...
#
# Rscript generate-r-universe.R /nix/store/sg15s0ikarg182sfzmhhqrq5f5zffq3z-source
...
with self; {
  ...
  dust2 = derive { name = "dust2"; version = "0.3.28"; buildInputs = [cli monty rlang cpp11 monty callr cpp11 decor fs glue knitr mockery numDeriv pkgbuild pkgload rmarkdown testthat withr]; };
  ...
  frogger = derive { name = "frogger"; version = "0.1.5"; buildInputs = [Rcpp beers dplyr eppasm hdf5r magrittr Rcpp tidyr abind docopt devtools knitr leapfrog RcppEigen reshape2 rmarkdown SpectrumUtils testthat withr xml2]; };
  ...
  hintr = derive { name = "hintr"; version = "1.2.14"; buildInputs = [digest docopt dplyr fs geojsonio glue ids jsonlite naomi naomi.options porcelain qs R6 readr readxl rlang rrq specio storr traduire V8 yaml zip callr cli covr duckdb httr jsonvalidate knitr mockery pkgload ps redux rmarkdown ssh testthat tidyselect withr]; };
  ...
  monty = derive { name = "monty"; version = "0.4.5"; buildInputs = [cli rlang cpp11 callr cpp11 coda decor knitr mockery mvtnorm numDeriv pkgload posterior rmarkdown testthat withr]; };
  ...
  odin2 = derive { name = "odin2"; version = "0.3.39"; buildInputs = [cli dust2 glue monty rlang decor deSolve fs knitr rmarkdown mockery numDeriv pkgload testthat withr]; };
  orderly = derive { name = "orderly"; version = "2.0.0"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi vctrs withr yaml DBI RSQLite callr jsonvalidate knitr mockery pkgload processx rmarkdown testthat webfakes]; };
  orderly_db = derive { name = "orderly.db"; version = "0.1.5"; buildInputs = [DBI fs jsonlite orderly RSQLite jsonvalidate knitr mockery rmarkdown testthat withr]; };
