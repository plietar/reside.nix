...
#
# Rscript generate-r-universe.R /nix/store/2bnca5iiszf98c7qi1r97vvw6nfzhrwh-source
...
with self; {
  ...
  monty = derive { name = "monty"; version = "0.3.31"; buildInputs = [R6 cli rlang cpp11 callr cpp11 coda decor knitr mockery mvtnorm numDeriv pkgload posterior rmarkdown testthat withr]; };
  ...
  odin2 = derive { name = "odin2"; version = "0.3.30"; buildInputs = [cli dust2 glue monty rlang decor deSolve fs knitr rmarkdown mockery numDeriv pkgload testthat withr]; };
  ...
  orderly2 = derive { name = "orderly2"; version = "1.99.71"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi withr yaml DBI RSQLite callr jsonvalidate knitr mockery pkgload processx rmarkdown stringr testthat webfakes]; };
