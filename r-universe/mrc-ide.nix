...
#
# Rscript generate-r-universe.R /nix/store/6a6nja991dff5bd4dh2s9765jpqmmd64-source
...
with self; {
  ...
  odin2 = derive { name = "odin2"; version = "0.3.29"; buildInputs = [cli dust2 glue monty rlang decor deSolve fs knitr rmarkdown mockery numDeriv pkgload testthat withr]; };
  ...
  orderly2 = derive { name = "orderly2"; version = "1.99.70"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi withr yaml DBI RSQLite jsonvalidate knitr mockery pkgload processx rmarkdown stringr testthat]; };
