...
#
# Rscript generate-r-universe.R /nix/store/l052dlanv67dj1nqsnwi683ph9a781c9-source
...
with self; {
  ...
  odin2 = derive { name = "odin2"; version = "0.3.27"; buildInputs = [cli dust2 glue monty rlang decor deSolve fs knitr rmarkdown mockery numDeriv pkgload testthat withr]; };
  ...
  orderly2 = derive { name = "orderly2"; version = "1.99.68"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi withr yaml DBI RSQLite jsonvalidate knitr mockery pkgload processx rmarkdown stringr testthat]; };
