...
#
# Rscript generate-r-universe.R /nix/store/9jkqvc1m7d8fvh1yasfaa2s4j7wsi5fn-source
...
with self; {
  ...
  orderly = derive { name = "orderly"; version = "2.0.1"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl pkgload rlang rstudioapi vctrs withr yaml DBI RSQLite callr jsonvalidate knitr mockery processx rmarkdown testthat webfakes]; };
