...
#
# Rscript generate-r-universe.R /nix/store/i5igrm783kcjvbyx9vp983q3w0kzplw1-source
...
with self; {
  ...
  orderly2 = derive { name = "orderly2"; version = "1.99.69"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi withr yaml DBI RSQLite jsonvalidate knitr mockery pkgload processx rmarkdown stringr testthat]; };
