...
#
# Rscript generate-r-universe.R /nix/store/a6md7kz3l9qrcak3zgyk283k2k8dvyc9-source
...
with self; {
  ...
  orderly = derive { name = "orderly"; version = "1.99.96"; buildInputs = [R6 cli diffobj fs gert httr2 jsonlite openssl rlang rstudioapi vctrs withr yaml DBI RSQLite callr jsonvalidate knitr mockery pkgload processx rmarkdown testthat webfakes]; };
